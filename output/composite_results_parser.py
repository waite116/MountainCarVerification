...
# assign director
folders = [folder for folder in os.listdir(os.getcwd()) if (folder.startswith('output_composite'))]
...
for folder in folders:
    ...
    for file in os.listdir(folder):
            ...
            if lines == []:
                ...
                for line in lines:
                    ...
                    if 'Initial conditions:' in line:
                        ...
                        left_x4_bound = lines[i+4].split()[0][1:-1]
                        right_x4_bound = lines[i+4].split()[1][0:-1]
                    i = i+1
        ...
        if verify_result == 'SAFE' and Decimal(left_x3_bound) == Decimal('0.5') and Decimal(right_x3_bound) == Decimal('2') and Decimal(left_x4_bound) == Decimal('0') and Decimal(right_x4_bound) == Decimal('.15'):
...
outfile_name = 'COMPOSITE_RESULTS_SUMMARY.txt'
