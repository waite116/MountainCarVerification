...
# assign director
folders = [folder for folder in os.listdir(os.getcwd()) if (folder.startswith('output_single_noise_blur'))]
print(folders)
...
for folder in folders:
    ...
    for file in os.listdir(folder):
        ...
        if verify_result == 'SAFE' and Decimal(left_x3_bound) == Decimal('0') and Decimal(right_x3_bound) == Decimal('.3'):
...
outfile_name = 'BLUR_RESULTS_SUMMARY.txt'
