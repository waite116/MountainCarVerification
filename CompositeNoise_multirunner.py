...
def main():
    xml_path = 'CompositeNoiseModel.xml'
    ...
    output_path = 'output/output_composite_'+int_str+'_' + start_str + '_' + end_str
    ...
    if test_set[-1][1] != end_val:
        ...
        subprocess.run([verisig_path, '-vc=CompositeNoise_multi.yml', '-o' ,'-nf', xml_path, dnn1_yaml, dnn2_yaml, dnn3_yaml, dnn4_yaml, dnn5_yaml])

        with open('CompositeNoiseModel.model', 'r') as f:
            in_model = f.read()
